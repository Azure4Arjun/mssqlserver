...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'sp_WhoIsActive', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [S1]    Script Date: 07/03/2019 11:06:07 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'S1', 
		...
		@command=N'EXEC master..sp_WhoIsActive @show_sleeping_spids = 1
