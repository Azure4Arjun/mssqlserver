...
SET @d = '2019-12-31T22:25:59.7901245';
...
SELECT FORMAT(GETDATE(), 'MMMM, yyyy') [FORMAT(GETDATE(), 'MMMM, yyyy')],       --> December, 2015
       FORMAT(GETDATE(), 'MMM-yyyy') [FORMAT(GETDATE(), 'MMM-yyyy')],         --> Dec-2015
       FORMAT(GETDATE(), 'dddd MMMM d') [FORMAT(GETDATE(), 'dddd MMMM d')],      --> Thursday December 31
       FORMAT(GETDATE(), 'yyyy -> MM -> dd') [FORMAT(GETDATE(), 'yyyy -> MM -> dd')], --> 2015 -> 12 -> 31
       FORMAT(GETDATE(), 'h\h, m\m') [FORMAT(GETDATE(), 'h\h, m\m')];         --> 10h, 25m
